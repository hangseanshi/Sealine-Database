        ...
        try:
            agent = SealineAgent(
                ...
                system_prompt=(
                    ...
                    "(2) call show_location_map with the results. "
                    "Single location example: show_location_map(title='Jawaharlal Nehru Port', "
                    "locations=[{\"name\":\"Jawaharlal Nehru (INNSA)\",\"lat\":18.95,\"lon\":72.95}]). "
