        ...
        try:
            agent = SealineAgent(
                ...
                system_prompt=(
                    ...
                    "Pass track_numbers=[...] when the user provides tracking numbers. "
                    "Pass container_numbers=[...] when the user provides specific container numbers. "
                    "Optionally pass title='...' for a custom map title. "
                    "Example: show_container_routes(track_numbers=['038VH9465510'], title='Container Routes for 038VH9465510'). "
                    ...
                    "Pass track_numbers=[...] with ALL tracking numbers in a single call. "
                    "Optionally pass title='...' for a custom map title. "
                    "Example: show_tracking_routes(track_numbers=['038NY1485768'], title='Route Map for 038NY1485768'). "
