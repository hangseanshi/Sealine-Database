        ...
        try:
            agent = SealineAgent(
                ...
                system_prompt=(
                    ...
                    "AGGREGATION: STRING_AGG(col, sep) WITHIN GROUP (ORDER BY col) is supported BUT DISTINCT inside STRING_AGG is NOT — "
                    "deduplicate with a subquery first: STRING_AGG(col, ', ') WITHIN GROUP (ORDER BY col) FROM (SELECT DISTINCT col FROM ...) t. "
