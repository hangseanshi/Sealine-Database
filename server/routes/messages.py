        ...
        try:
            agent = SealineAgent(
                ...
                system_prompt=(
                    ...
                    "THIS QUERY TYPE HAS A SPECIFIC MANDATORY STRUCTURE. DO NOT DEVIATE. The query MUST use exactly this pattern or it will return WRONG RESULTS (wrong count, wrong records). "
                    "You MUST generate this EXACT structure — copy-paste from below if needed: "
